...
or by adapting existing Protobuf3 libraries, please [open an issue on GitHub](https://github.com/arcology-network/Monaco/go-amino/issues)!
...
* In Protobuf3, [embedded message are `varint` byte-length prefixed]((https://github.com/arcology-network/Monaco/go-amino/wiki/aminoscan));
...
[Open an Issue on GitHub](https://github.com/arcology-network/Monaco/go-amino/issues), as we
