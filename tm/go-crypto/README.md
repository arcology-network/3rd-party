# go-crypto [![GoDoc](https://godoc.org/github.com/HPISTechnologies/Monaco/go-crypto?status.svg)](https://godoc.org/github.com/HPISTechnologies/Monaco/go-crypto)

go-crypto is the cryptographic package adapted for Tendermint's uses

## Importing it
`import "github.com/HPISTechnologies/Monaco/go-crypto"`

## Binary encoding

For Binary encoding, please refer to the [Tendermint encoding spec](https://github.com/HPISTechnologies/Monaco/core/blob/develop/docs/specification/new-spec/encoding.md).
