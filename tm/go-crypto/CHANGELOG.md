...
- `github.com/arcology-network/Monaco/go-keys -> github.com/arcology-network/Monaco/go-crypto/keys` - command and lib for generating and managing encrypted keys
